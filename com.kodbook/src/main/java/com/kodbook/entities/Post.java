...
public class Post {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)//generate the id automatic
	private Long id;
	...
	@Column(columnDefinition = "LONGBLOB")//above three are format or datatype to store the photo
	private byte[] photo;
	
	//to store the photo in the database in base64 format
